...
# Logging sazlamalary - Railway gormek ucin INFO
logging.basicConfig(
...
# Cikis utgeyjileri (Railway'de sazlanar)
...
Bu bot bilen awtomatik usulda VPN ulanyjylary doredip bilersiňiz.

Buyruklar:
• /create - Teze ulanyjy doret
• /status - Bot yagdayyny barla
• /help - Komek menýusy

Dymyky Sazlamalar:
• Data Limit: {DEFAULT_DATA_LIMIT_GB} GB
• Wagt: {DEFAULT_EXPIRE_DAYS} gun
"""
    keyboard = [
...
"
                f"Telegram Bot: Bagly
"
                f"Marzban Panel: Bagly
"
...
"
        ...
        if result:
            ...
            if user_info:
                ...
                message = f"""Ulanyjy Ustunlikli Doredildi!

Ulanyjy Ady: {username}
Data Limit: {data_limit_gb} GB
Gutaryan Sene: {expire_date}
Yagdayy: Aktiv
...
Nadip Ulanylýar?
"
                message += "1. V2RayNG, Nekoray ya-da menzes programma yuklen
"
                message += "2. Abunalyk linkini ya-da konfigurasiýa linklerini programa goshun
"
                message += "3. Baglanyn we ulanmaga bashlan!"
...
def main():
    # TOKEN barlagy - Railway loglarynda gormek ucin
